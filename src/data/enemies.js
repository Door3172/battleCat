export const ENEMIES = {
  ...
  black: { name: '黑影怪', hp: 100, speed: 90, attack: 35, range: 18, atkRate: 1.5, color: '#0f172a', bounty: 100, aoe: false },
  alien: { name: '外星', hp: 160, speed: 56, attack: 24, range: 80, atkRate: 2, color: '#7c3aed', bounty: 50, aoe: true, aoeRadius: 50, maxTargets: 2 },
