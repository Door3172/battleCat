export const ENEMIES = {
  ...
  clownfish: { name: '小丑魚', hp: 135, speed: 33, attack: 15, range: 20, atkRate: 2, color: '#f45f03ff', bounty: 27, aoe: false },
  angelfish: { name: '神仙魚', hp: 180, speed: 40, attack: 8, range: 20, atkRate: 1.6, color: '#ffe9dcff', bounty: 35, aoe: false },
  ...
  hermitCrab: { name: '寄居蟹', hp: 760, speed: 15, attack: 90, range: 30, atkRate: 3, color: '#e1ac62ff', bounty: 200, aoe: true, aoeRadius: 30, maxTargets: 3, abilities: { shield: { interval: 45, amount: 500 } } },
  babySquid: { name: '小墨魚', hp: 200, speed: 25, attack: 110, range: 85, atkRate: 2.2, color: '#ba4e55ff', bounty: 80, aoe: true, aoeRadius: 85, maxTargets: 3, abilities: { slow: { chance: 0.4, duration: 0.9, factor: 0.7 } } },
  octopusling: { name: '小章魚', hp: 335, speed: 42, attack: 42, range: 45, atkRate: 1.7, color: '#ce3757ff', bounty: 100, aoe: true, aoeRadius: 45, maxTargets: 5, abilities: { revive: { chance: 0.5, percent: 0.1 } } },
  dolphin: { name: '海豚', hp: 850, speed: 150, attack: 100, range: 45, atkRate: 3.3, color: '#91c4cdc4', bounty: 300, aoe: true, aoeRadius: 85, aoeMinRadius: 10, maxTargets: 3, abilities: { knockback: { chance: 0.6, distance: 15 } } },
...
export const BOSSES = {
  ...
  ghostShark: { name: '幽靈鯊', hp: 2800, speed: 42, attack: 360, range: 30, atkRate: 0.9, color: '#206facff', bounty: 2100, aoe: false, abilities: { lifesteal: { chance: 0.05, percent: 0.03 }, berserk: { threshold: 0.25, attackUp: 1.5 }, dodge: { chance: 0.2 }, freezeImmune: true, knockbackImmune: true, slowImmune: true } },
};
