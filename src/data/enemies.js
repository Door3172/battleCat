export const ENEMIES = {
  ...
  snake: { name: '小蛇', hp: 160, speed: 25, attack: 20, range: 20, atkRate: 1.8, color: '#c5cce1ff', bounty: 25, aoe: true, aoeRadius: 20, aoeMinRadius: 10 },
...
export const BOSSES = {
  boarKing: { name: '野豬王', hp: 3600, speed: 14, attack: 30, range: 24, atkRate: 0.3, color: '#78350f', bounty: 750, aoe: true, aoeRadius: 16, aoeMinRadius: 8, maxTargets: 2 },
