export const BASE_CATS = {
  ...
  giant: { name: '巨人喵', cost: 750, hp: 1725, speed: 20, attack: 77, range: 38, atkRate: 1.7, color: '#ddd6fe', cd: 20.0, aoe: true, aoeRadius: 38, maxTargets: 3 },
  ...
  lizard: { name: '蜥蜴喵', cost: 350, hp: 300, speed: 32, attack: 80, range: 240, atkRate: 2, color: '#fca5a5', cd: 16.0, aoe: false },
};

export const SHOP_UNLOCKS = {
  ninja: { name: '忍者喵', price: 120, tpl: { name: '忍者喵', cost: 150, hp: 160, speed: 90, attack: 9, range: 50, atkRate: 0.4, color: '#fde68a', cd: 2.0, aoe: false } },
  knight: { name: '騎士喵', price: 360, tpl: { name: '騎士喵', cost: 200, hp: 650, speed: 60, attack: 16, range: 35, atkRate: 1.2, color: '#fda4af', cd: 4.8, aoe: false } },
