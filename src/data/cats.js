export const BASE_CATS = {
  ...
  archer: { name: '射喵', cost: 225, hp: 130, speed: 50, attack: 9, range: 85, atkRate: 0.35, color: '#bae6fd', cd: 4.0, aoe: false, hpIncrement: 9, atkIncrement: 1 },
  giant: { name: '巨人喵', cost: 1500, hp: 2500, speed: 14, attack: 123, range: 35, atkRate: 1.7, color: '#ddd6fe', cd: 26.0, aoe: true, aoeRadius: 35, maxTargets: 3, hpIncrement: 250, atkIncrement: 11 },
  ...
  lizard: { name: '蜥蜴喵', cost: 600, hp: 300, speed: 18, attack: 130, range: 200, atkRate: 2.5, color: '#fca5a5', cd: 16.0, aoe: false, hpIncrement: 30, atkIncrement: 25 },
};
...
export const SHOP_UNLOCKS = {
  ...
  knight: { name: '騎士喵', price: 300, tpl: { name: '騎士喵', cost: 330, hp: 960, speed: 85, attack: 110, range: 40, atkRate: 5, color: '#fda4af', cd: 5.0, aoe: true, aoeRadius: 65, maxTargets: 3, hpIncrement: 40, atkIncrement: 25 } },
  ...
  sumo: { name: '相撲喵', price: 300, tpl: { name: '相撲喵', cost: 240, hp: 1250, speed: 36, attack: 1, range: 20, atkRate: 0.1, color: '#fecaca', cd: 3.3, aoe: true, aoeRadius: 20, maxTargets: 2, hpIncrement: 125, atkIncrement: 0.5 } },
  ...
  jaycat: { name: '禁節貓娘', price: 520, tpl: { name: '禁節貓娘', cost: 10, hp: 1, speed: 45, attack: 1, range: 35, atkRate: 0.01, color: '#eb52c7ff', cd: 18.0, aoe: true, aoeRadius: 30, maxTargets: 3, hpIncrement: 0, atkIncrement: 1 } },
  ...
  void: { name: '虛空秘典喵', price: 1200, tpl: { name: '虛空秘典喵', cost: 2400, hp: 200, speed: 15, attack: 1600, range: 160, atkRate: 8.8, color: '#3e2351ff', cd: 90.0, aoe: true, aoeRadius: 160, hpIncrement: 30, atkIncrement: 250 } },
};
