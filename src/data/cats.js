...
export const SHOP_UNLOCKS = {
  ...
  samurai: { name: '武士喵', price: 360, tpl: { name: '武士喵', cost: 350, hp: 540, speed: 25, attack: 30, range: 26, atkRate: 0.6, color: '#94a3b8', cd: 5.4, aoe: false, hpIncrement: 40, atkIncrement: 5 } },//+
  ...
  viking: { name: '維京喵', price: 400, tpl: { name: '維京喵', cost: 420, hp: 300, speed: 45, attack: 130, range: 24, atkRate: 1.0, color: '#bfdbfe', cd: 6.0, aoe: true, aoeRadius: 24, maxTargets: 3, hpIncrement: 25, atkIncrement: 15, abilities: { berserk: { threshold: 0.4, attackUp: 0.5 } } } },//+
  ...
  azurePhantom: { name: '蒼藍幻影喵', price: 1200, tpl: { name: '蒼藍幻影喵', cost: 1800, hp: 320, speed: 21, attack: 220, range: 140, atkRate: 2.4, color: '#32516eff', cd: 85.0, aoe: true, aoeRadius: 140, hpIncrement: 50, atkIncrement: 60, abilities: { slow: { chance: 0.3, duration: 1.2, factor: 0.5 } } } },//-
};
