...
export const SPAWNS = {
  ...
  10: {
    ...
    towerDistance: 800,
    reward: 400,
    boss: { time: 1, key: 'boarKing', hp: 2000 },
    schedule: [
      ...
      { start: 1, interval: 20, type: 'black', hp: 2000, multiplier: 150 },
      { start: 1, interval: 60, type: 'snail', hp: 2200, multiplier: 100 },
  ...
  14: {
    ...
    schedule: [
      ...
      { start: 10, interval: 10, type: 'alien', multiplier: 125 },
      { start: 16, interval: 16, type: 'alien', multiplier: 175 },
      { start: 21, interval: 21, type: 'alien', multiplier: 200 },
      { start: 26, interval: 26, type: 'alien', multiplier: 225 },
      { start: 32, interval: 32, type: 'alien', multiplier: 150 },
      { start: 40, interval: 40, type: 'alien', multiplier: 275 },
  ...
  15: {
    ...
    schedule: [
      ...
      { start: 5, interval: 20, type: 'dog', multiplier: 400 },
      { start: 5, interval: 28, type: 'snake', multiplier: 225 },
      { start: 15, interval: 37, type: 'hippo', multiplier: 200 },
      { start: 10, interval: 50, type: 'bull', multiplier: 125 },
      { start: 0, interval: 48, type: 'snail', multiplier: 150 },
      { start: 20, interval: 35, type: 'alien', multiplier: 150 },
  ...
  18: {
    ...
    reward: 600,
    schedule: [
      { time: 5, type: 'bull', multiplier: 275 },
      { start: 20, interval: 18, type: 'bull', multiplier: 100 },
      { start: 35, interval: 30, type: 'bull', multiplier: 125 },
  ...
  19: {
    ...
    schedule: [
      ...
      { time: 40, type: 'boar', multiplier: 300 },
    ],
  },
  20: {
    enemyBaseHp: 3200,
    ...
    schedule: [
      ...
      { start: 7, interval: 16, type: 'dog', multiplier: 500 },
      { start: 11, interval: 25, type: 'dog', multiplier: 300 },
      { start: 7, interval: 25, type: 'snake', multiplier: 325 },
      { start: 15, interval: 31, type: 'black', multiplier: 225 },
      { start: 10, interval: 39, type: 'hippo', multiplier: 225 },
      { start: 0, interval: 45, type: 'snail', multiplier: 225 },
      { start: 10, interval: 24, type: 'alien', multiplier: 175 },
      { interval: 20, type: 'black', hp: 3000, multiplier: 200 },
      { interval: 20, type: 'boar', hp: 3000, multiplier: 225 },
    ],
  },
};
