...
export const SPAWNS = {
  ...
  3: {
    ...
    reward: 120,
    schedule: [
      { start: 10, interval: 17, type: 'dog', multiplier: 110 },
      { start: 30, interval: 13, type: 'dog', multiplier: 105 },
      { start: 8, interval: 15, type: 'snake', multiplier: 105 },
      { time: 30, type: 'snake', multiplier: 150 },
    ],
  },
  4: {
    enemyBaseHp: 650,
  ...
  5: {
    ...
    reward: 180,
    schedule: [
      { start: 8, interval: 10, type: 'dog', multiplier: 120 },
      { start: 16, interval: 18, type: 'red', multiplier: 100 },
      { start: 11, interval: 15, type: 'snake', multiplier: 110 },
      { time: 1, type: 'hippo', multiplier: 100 },
      { time: 37, type: 'red', multiplier: 115 },
    ],
  },
  6: {
    enemyBaseHp: 850,
    reward: 200,
    schedule: [
      { start: 8, interval: 12, type: 'dog', multiplier: 120 },
      { start: 22, interval: 13, type: 'dog', multiplier: 90 },
      { start: 16, interval: 23, type: 'red', multiplier: 100 },
      { start: 5, interval: 47, type: 'red', multiplier: 110 },
      { start: 11, interval: 12, type: 'snake', multiplier: 130 },
      { start: 6, interval: 21, type: 'snake', multiplier: 100 },
      { time: 30, type: 'black', multiplier: 100 },
      { time: 30, type: 'black', multiplier: 100 },
      { time: 130, type: 'black', multiplier: 90 },
      { time: 130, type: 'black', multiplier: 105 },
      { time: 130, type: 'black', multiplier: 105 },
    ],
  },
  7: {
    ...
    reward: 200,
    schedule: [
      { start: 8, interval: 8, type: 'dog', multiplier: 110 },
      { start: 12, interval: 17, type: 'red', multiplier: 110 },
      { start: 10, interval: 10, type: 'snake', multiplier: 110 },
      { start: 5, interval: 40, type: 'hippo', multiplier: 110 },
      { start: 6, interval: 21, type: 'black', multiplier: 110 },
      { time: 30, type: 'boar', multiplier: 110 },
  ...
  8: {
    ...
    reward: 220,
    schedule: [
      { start: 10, interval: 18, type: 'red', multiplier: 110 },
      { start: 10, interval: 10, type: 'snake', multiplier: 120 },
      { start: 10, interval: 15, type: 'black', multiplier: 110 },
      { time: 60, type: 'boar', multiplier: 120 },
      { time: 1, type: 'boar', hp: 600, multiplier: 120 },
      { time: 1, type: 'boar', hp: 500, multiplier: 150 },
    ],
  },
  9: {
    enemyBaseHp: 1200,
    reward: 240,
    schedule: [
      { start: 15, interval: 16, type: 'red', multiplier: 115 },
      { start: 6, interval: 28, type: 'boar', multiplier: 105 },
      { start: 12, interval: 24, type: 'hippo', multiplier: 105 },
      { time: 25, type: 'alien', multiplier: 100 },
      { time: 40, type: 'alien', multiplier: 130 },
  ...
  10: {
    ...
    schedule: [
      ...
      { start: 30, interval: 24, type: 'dog', multiplier: 110 },
      { start: 32, interval: 28, type: 'red', multiplier: 110 },
