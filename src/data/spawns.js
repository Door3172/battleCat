...
export const SPAWNS = {
  ...
  5: {
    ...
    schedule: [
      ...
      { time: 37, type: 'red', multiplier: 120 },
    ],
  },
  6: {
    enemyBaseHp: 850,
    ...
    schedule: [
      ...
      { start: 5, interval: 47, type: 'red', multiplier: 175 },
      ...
      { time: 130, type: 'black', multiplier: 200 },
    ],
  },
  7: {
    enemyBaseHp: 1050,
  ...
  8: {
    ...
    schedule: [
      ...
      { time: 1, type: 'boar', hp: 500, multiplier: 275 },
    ],
  },
  9: {
    enemyBaseHp: 1200,
    ...
    schedule: [
      ...
      { time: 90, type: 'alien', multiplier: 150 },
    ],
  },
  10: {
    enemyBaseHp: 1500,
    ...
    schedule: [
      ...
      { start: 1, interval: 20, type: 'black', hp: 1400, multiplier: 125 },
  ...
  11: {
    ...
    schedule: [
      ...
      { start: 60, interval: 35, type: 'dog', multiplier: 600 },
      { time: 60, type: 'bull', multiplier: 100 },
      { time: 65, type: 'bull', multiplier: 100 },
      { time: 70, type: 'bull', multiplier: 100 },
    ],
  },
  12: {
    enemyBaseHp: 1000,
    ...
    reward: 360,
    schedule: [
      { start: 10, interval: 18, type: 'red', multiplier: 150 },
      { start: 30, interval: 28, type: 'red', multiplier: 250 },
      { start: 45, interval: 35, type: 'red', multiplier: 350 },
      { start: 30, interval: 20, type: 'red', hp: 900, multiplier: 150 },
      { start: 45, interval: 32, type: 'red', hp: 800, multiplier: 175 },
      { start: 90, interval: 21, type: 'red', hp: 300, multiplier: 200 },
      { start: 180, interval: 180, type: 'red', hp: 50, multiplier: 700 },
    ],
  },
  13: {
    enemyBaseHp: 1200,
    ...
    reward: 390,
    schedule: [
      { start: 10, interval: 15, type: 'dog', multiplier: 200 },
      { start: 10, interval: 28, type: 'dog', multiplier: 400 },
      { start: 10, interval: 40, type: 'hippo', multiplier: 175 },
      { start: 10, interval: 18, type: 'snake', multiplier: 300 },
      { time: 40, type: 'bull', multiplier: 100 },
  ...
  14: {
    ...
    reward: 400,
    schedule: [
      { start: 10, interval: 10, type: 'alien', multiplier: 100 },
      { start: 15, interval: 15, type: 'alien', multiplier: 125 },
      { start: 20, interval: 20, type: 'alien', multiplier: 150 },
      { start: 25, interval: 25, type: 'alien', multiplier: 175 },
      { start: 35, interval: 35, type: 'alien', multiplier: 200 },
      { time: 60, type: 'alien', multiplier: 250 },
      { time: 65, type: 'alien', multiplier: 200 },
    ],
  },
  15: {
    enemyBaseHp: 2000,
    ...
    schedule: [
      ...
      { start: 5, interval: 24, type: 'snake', multiplier: 200 },
      { start: 15, interval: 35, type: 'hippo', multiplier: 200 },
      { start: 10, interval: 40, type: 'bull', multiplier: 100 },
      { start: 0, interval: 45, type: 'snail', multiplier: 150 },
      { time: 45, type: 'alien', multiplier: 150 },
    ],
  },
  16: {
    enemyBaseHp: 1500,
    ...
    schedule: [
      ...
      { start: 0, interval: 40, type: 'black', multiplier: 150 },
  ...
  18: {
    ...
    reward: 440,
    schedule: [
      { time: 5, type: 'bull', multiplier: 200 },
      ...
      { time: 300, type: 'bull', multiplier: 500 },
    ],
  },
  19: {
    enemyBaseHp: 2000,
    ...
    schedule: [
      ...
      { start: 32, interval: 23, type: 'boar', multiplier: 200 },
  ...
  20: {
    ...
    schedule: [
      { time: 15, type: 'bull', multiplier: 125 },
      { time: 15, type: 'elephant', multiplier: 125 },
      { start: 7, interval: 15, type: 'dog', multiplier: 400 },
      { start: 11, interval: 23, type: 'dog', multiplier: 300 },
      { start: 7, interval: 24, type: 'snake', multiplier: 300 },
      { start: 15, interval: 31, type: 'black', multiplier: 200 },
      { start: 10, interval: 37, type: 'hippo', multiplier: 200 },
      { start: 0, interval: 45, type: 'snail', multiplier: 200 },
      { start: 10, interval: 23, type: 'alien', multiplier: 125 },
      { start: 1, interval: 20, type: 'black', hp: 2000, multiplier: 125 },
      { start: 1, interval: 20, type: 'boar', hp: 2000, multiplier: 150 },
    ],
  },
};
